            ...
            <div style={{ display: "flex", flexDirection: "column", height: "100vh" }}>
                <BaseCenterContainer style={{ zoom: 0.9 }}>
                    ...
                    <div className={styles.background}>
                        ...
                        <div className={styles.base_path}><Link to={"../"} style={{color: "var(--color-gray-1100)", textDecoration: "none"}}>Главная</Link> / <span style={{ color: " var(--color-white)" }}>Каталог внутренней валюты</span></div>
